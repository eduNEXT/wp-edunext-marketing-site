...
<h2><?= __( 'Visit "Appearance -> Menus" and look for the "Open edX WP integrator" box on the left column to build the Open edX user menu for your WP site.', 'wp-edunext-marketing-site' ) ?></h2>
