...
jQuery(document).ready(function($){
    ...
    var testing = function(){
        ...
        if (ENEXT.amILoggedIn()) {
            $logCookieStatus.html(' ✓ Cookie "edxloggedin" found! ').removeClass('error');
        } else {
            $logCookieStatus.html(' ✘ Cookie "edxloggedin" not found! Maybe you are not logged in? ').addClass('error');
        }

    	// Cookie testing
        if (ENEXT_SRV.sessionid_cookie) {
            $sessionCookieStatus.html(' ✓ Cookie "sessionid" found! ').removeClass('error');
        } else {
            $sessionCookieStatus.html(' ✘ Cookie "sessionid" not found! Maybe you are not logged in? ').addClass('error');
        }
