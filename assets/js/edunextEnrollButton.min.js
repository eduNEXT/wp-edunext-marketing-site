...
ENEXT.registration = (function($){
  ...
  var getCourseData = function(enrollmentApiLocation, courseID, enrollmentData, $anchor) {
    ...
    .done(function(data) {
      ...
      if (amIEnrolled) {
        if (hasCourseStarted) {
          renderAction('go_to_course', $anchor, openedxDomain + "/courses/" + courseID + "/info");
        } else {
          renderAction('course_has_not_started', $anchor, openedxDomain + "/dashboard");
        }
      } else if (isInvitationOnly) {
        renderAction('invitation_only', $anchor);
      } else if (isRegistrationOpen) {
        renderAction('enroll_not_logged_in', $anchor, openedxDomain + "/register?course_id=" + courseID + "&enrollment_action=enroll");
      } else {
